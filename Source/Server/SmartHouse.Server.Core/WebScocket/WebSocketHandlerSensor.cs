...
namespace SmartHouse.Server.Core.WebScocket {
	public class WebSocketHandlerSensor : WebSocketHandler {

		public WebSocketHandlerSensor(WebSocketConnectionManager webSocketConnectionManager) : base(webSocketConnectionManager) { }
